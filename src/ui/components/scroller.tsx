...
export const HANDLE_BAR_WIDTH = 24;
export const HANDLE_BAR_PADDING = 4;
...
export const Scroller = VerticalScroller;
	...
	return (
		...
		>
			<scrollingframe
				scope={scope}
				BackgroundTransparency={1}
				Size={new UDim2(1, 0, 1, -HANDLE_BAR_WIDTH - HANDLE_BAR_PADDING)}
				CanvasSize={new UDim2(1, 0, 1, 0)}
